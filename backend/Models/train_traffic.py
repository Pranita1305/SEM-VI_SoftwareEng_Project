#!/usr/bin/env python
"""Train a traffic index prediction model."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train traffic index model.")
    parser.add_argument(
        "--data",
        type=Path,
        required=True,
        help="Path to weather_traffic.csv",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
...
def main() -> None:
    ...
    df = df.dropna(subset=["traffic_index"])
